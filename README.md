...
Build and visualise interactive word co-occurrence networks from plain-text files. Control window size, minimum frequency thresholds, and network layout. Networks can be exported as images or data files.
...
| Host | URL |
|------|-----|
| ARDC BinderHub ⭐ | `https://binderhub.atap-binder.cloud.edu.au/v2/gh/SLCLADAL/tools-env/main?urlpath=git-pull%3Frepo%3Dhttps%253A%252F%252Fgithub.com%252FSLCLADAL%252Ftools%26urlpath%3Dlab%252Ftree%252Ftools%252Fwordmapper_launcher.ipynb%26branch%3Dmain` |
| MyBinder.org | `https://mybinder.org/v2/gh/SLCLADAL/tools-env/main?urlpath=git-pull%3Frepo%3Dhttps%253A%252F%252Fgithub.com%252FSLCLADAL%252Ftools%26urlpath%3Dlab%252Ftree%252Ftools%252Fwordmapper_launcher.ipynb%26branch%3Dmain` |
...
| `DT` | All tools |
| `zip` | All tools |
| `writexl` | WordFinder, KeywordExtractor, POSTagger |
| `tidyverse` | WordFinder, KeywordExtractor, POSTagger, TextCleaner |
| `quanteda` | WordFinder, KeywordExtractor |
| `quanteda.textstats` | KeywordExtractor |
| `quanteda.textplots` | WordFinder (dispersion plot) |
| `igraph` | WordMapper |
| `visNetwork` | WordMapper |
| `udpipe` | POSTagger |
| `stringi` | TextCleaner, FileRenamer |
| `data.table` | TextCleaner |
