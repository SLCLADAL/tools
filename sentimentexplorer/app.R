...
CITATION_FOOTER <- tags$div(
  ...
  tags$div(
    ...
    tags$a("→ Tutorial", href = "https://ladal.edu.au/tutorials/sentiment/sentiment.html", target = "_blank",
  ...
  tags$blockquote(
    ...
    HTML(paste0(
      ...
      "<em>SentimentExplorer: A browser-based sentiment analysis tool</em>. ",
  ...
  tags$details(
    ...
    tags$pre(
      ...
      paste0(
        "@misc{schweinberger2025sentimentexplorer,\n",
        "  author       = {Schweinberger, Martin},\n",
        "  title        = {SentimentExplorer: A browser-based sentiment analysis tool},\n",
        "  year         = {2025},\n",
...
'@article{mohammad13,
  ...
  output$dl_params <- downloadHandler(
    ...
    content  = function(file) {
      lines <- c(
        paste0("Tool:                ", "SentimentExplorer — Sentiment Analysis"),
  ...
  output$params_dl_ui <- renderUI({
    downloadButton("dl_params", "⬇ Download parameters (.txt)", class = "se-dl-btn")
  })
